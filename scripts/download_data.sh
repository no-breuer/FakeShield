...
huggingface-cli download --resume-download zhipeixu/fakeshield-v1-22b --local-dir "${WEIGHT_DIR}/fakeshield-v1-22b"

echo "==== Downloading SAM ViT-H weight (~2.5 GB) ===="
huggingface-cli download --resume-download ybelkada/segment-anything \
...
huggingface-cli download --resume-download zhipeixu/SD_inpaint_dataset --repo-type dataset \
    --local-dir "${DATA_DIR}/aigc/SD_inpaint"

echo "==== Downloading MMTD-Set-34k ===="
huggingface-cli download --resume-download zhipeixu/MMTD-Set-34k --repo-type dataset \
